...
-- For fresh databases. If you already applied an older db.sql, migrate manually
-- (enums, subjects columns, fixed_groups shape, subject_room_types).
...
-- classroom_type is free-form VARCHAR (matches SQLAlchemy String(100)), not a DB enum
...
-- subjects: no room_type / classes_per_week here — see subject_room_types
...
CREATE TABLE IF NOT EXISTS subject_room_types (
